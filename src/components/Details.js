                ...
                return (
                    <div className="container py-5">
                        <div className="row">
                            ...
                            <div className="col-10 mx-auto text-center text-capitalized text-slanted text-darkGreen my-5">
                                <h1>Model : {title}</h1>
                                ...
                                <h4 className="text-darkGreen"><strong>price: <span> {price}</span></strong></h4>
